...
class Home extends Component {
  render() {
    return (
      <div>
        <CenteredHeader>Hi! I'm Sophia. I'm a software developer and work remotely.</CenteredHeader>
        <p>
          I've worked throughout the stack, but I especially love building React UI. I've most recently worked as a Web Engineer at Spotify and a Software Engineer at the New York Times.
        </p>
        <p>
